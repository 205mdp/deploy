...
demoApp.controller('TodoCtrl', function ($scope, $http, localStorageService, simpleFactoryx) {
    init();
    function init() {
        var tempx = localStorageService.get('localStorageDemo');
        if (tempx == null) {
            localStorageService.add('localStorageDemo', simpleFactoryx.gettodos());
        }
    ...
    $scope.test = function (todo) {
        ...
        localStorageService.add('localStorageDemo', $scope.todosx);
...
demoApp.factory("simpleFactoryx", function ($http) {
